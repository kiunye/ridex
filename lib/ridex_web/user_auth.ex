defmodule RidexWeb.UserAuth do
  use RidexWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ridex_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      RidexWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  ## `on_mount` arguments
    ...
    * `:redirect_if_user_is_authenticated` - Authenticates the user from the session.
      Redirects to signed_in_path if user is authenticated.
  ...
  the current_user:
      ...
      defmodule RidexWeb.PageLive do
        use RidexWeb, :live_view

        on_mount {RidexWeb.UserAuth, :mount_current_user}
        ...
      end
  ...
  callback for all LiveViews in the session:
      ...
      live_session :authenticated, on_mount: [{RidexWeb.UserAuth, :ensure_authenticated}] do
